...
__all__ = [
    ...
    'DISPID_SFSClose', 'SpInProcRecoContext', 'SVSFNLPMask',
    'ISpeechRecognizerStatus', 'SPEI_END_INPUT_STREAM',
    '_SPAUDIOSTATE', 'SVP_7', 'DISPID_SPELexicalForm',
    'SPGS_EXCLUSIVE', 'SSTTDictation', 'eLEXTYPE_PRIVATE16',
    'SRTEmulated', 'SPLOADOPTIONS', 'SRTStandard',
    'DISPID_SRRRecoContext', 'IEnumSpObjectTokens', 'SVP_14',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SVSInputSentenceLength',
    'DISPID_SRRTimes', 'DISPID_SRCSetAdaptationData',
    'SAFT22kHz16BitMono', 'SAFT16kHz8BitStereo', 'SGRSTTDictation',
    'DISPID_SGRs_NewEnum', 'DISPID_SPRulesItem',
    'DISPID_SPRules_NewEnum', 'SPEI_MAX_TTS', 'SpeechRecognitionType',
    'DISPID_SGRsCount', 'SPCS_DISABLED',
    'SpeechPropertyLowConfidenceThreshold', 'SGSExclusive',
    'SpStream', 'SPGRAMMARSTATE', 'SVP_10', 'SpeechPartOfSpeech',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SRCEFalseRecognition',
    'SpeechRetainedAudioOptions', 'DISPID_SpeechPhraseProperty',
    'SSFMCreateForWrite', 'SPPHRASERULE',
    'DISPID_SpeechXMLRecoResult', 'SPCT_SUB_COMMAND',
    'DISPID_SPEPronunciation', 'eLEXTYPE_PRIVATE18', 'SDTAudio',
    'SITooSlow', 'SPSVerb', 'IInternetSecurityManager',
    'DISPID_SRSetPropertyString', 'SPINTERFERENCE_NOSIGNAL',
    'ISpeechRecoGrammar', 'Speech_StreamPos_RealTime',
    'SVSFPurgeBeforeSpeak', 'SpMMAudioEnum',
    'SpPhoneticAlphabetConverter', 'eLEXTYPE_PRIVATE14',
    'SPEI_SOUND_START', 'SAFT44kHz16BitMono', 'DISPID_SGRAddResource',
    'DISPID_SASetState', 'SpeechRecoProfileProperties',
    'Speech_Default_Weight', 'ISpDataKey', 'eWORDTYPE_ADDED',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPWF_INPUT', 'SAFT8kHz8BitStereo',
    'SPEI_RESERVED1', 'ISpSerializeState', 'eLEXTYPE_PRIVATE15',
    'DISPID_SVAudioOutput', 'ISpRecoGrammar2', 'SREAllEvents',
    'SDTLexicalForm', 'DISPID_SABufferNotifySize',
    'DISPID_SMSADeviceId', 'SREInterference',
    'DISPID_SVIsUISupported', 'DISPID_SRCEHypothesis',
    '_RemotableHandle', 'SAFT12kHz8BitMono',
    'DISPID_SpeechPhraseAlternate', 'SRERecognition',
    'DISPID_SGRAddState', 'SpeechAudioFormatType', 'SpVoice',
    'SPWORDLIST', 'SpeechSpecialTransitionType',
    'eLEXTYPE_VENDORLEXICON', 'SPSERIALIZEDPHRASE',
    'SPEI_SR_BOOKMARK', 'DISPID_SGRSRule', 'ISpeechFileStream',
    'eLEXTYPE_PRIVATE13', 'SpeechVoiceEvents', 'STSF_LocalAppData',
    'ISpeechPhraseInfoBuilder', 'ISpRecoCategory', 'DISPID_SVPause',
    'DISPID_SDKSetStringValue', 'SpeechUserTraining',
    'ISpeechBaseStream', 'DISPID_SPIGetDisplayAttributes',
    'SPEI_START_SR_STREAM', 'SVP_13', 'SP_VISEME_2',
    'DISPID_SPCLangId', 'SpeechRecoContextState', 'DISPID_SRRAudio',
    'ISpStreamFormat', 'ISpPhoneticAlphabetSelection',
    'SVEStartInputStream', 'DISPID_SOTsItem',
    'DISPID_SPEAudioStreamOffset', 'SPCATEGORYTYPE',
    'DISPID_SOTCGetDataKey', 'DISPID_SGRSTWeight', 'SPAUDIOSTATUS',
    'SAFT12kHz16BitStereo', 'DISPID_SpeechVoice',
    'Speech_Max_Word_Length', 'eLEXTYPE_PRIVATE6', 'DISPID_SOTCSetId',
    'SAFTGSM610_22kHzMono', 'SPSUnknown', 'SpeechAudioFormatGUIDText',
    'SVP_9', 'DISPID_SPARecoResult', 'ISpeechMemoryStream',
    'SPEI_SOUND_END', 'DISPID_SVGetAudioOutputs',
    'DISPID_SGRSTs_NewEnum', 'SpeechAddRemoveWord',
    'DISPID_SPPConfidence', '_ISpeechVoiceEvents',
    'SpeechDiscardType', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPEVENTSOURCEINFO', 'DISPID_SpeechPhraseRules', 'SpMMAudioIn',
    'DISPIDSPTSI_ActiveLength', 'SVPOver', 'DISPID_SGRSTransitions',
    'DISPID_SVSInputWordPosition', 'SVEWordBoundary',
    'DISPID_SGRSTsCount', 'SITooFast', 'SREPrivate', 'SPAR_Low',
    'ISpObjectTokenCategory', 'SRAImport', 'SPDKL_DefaultLocation',
    'SPPS_Noncontent', 'DISPID_SWFEExtraData', 'SP_VISEME_21',
    'DISPID_SGRsFindRule', 'DISPID_SABIEventBias',
    'DISPID_SDKSetLongValue', 'SPEI_VISEME', 'DISPID_SPCPhoneToId',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SpeechBaseStream', 'DISPIDSPTSI_SelectionOffset',
    'SGLexicalNoSpecialChars', 'DISPID_SPIProperties',
    'DISPID_SPPFirstElement', 'SPEI_ADAPTATION', 'SDTAlternates',
    'DISPID_SpeechPhraseInfo', 'SPPS_RESERVED3',
    'SpeechRegistryLocalMachineRoot', 'ISpRecoResult', 'SRTAutopause',
    ...
    'DISPID_SGRAttributes', 'SPAS_CLOSED', 'DISPID_SLPType',
    'SpeechEngineConfidence', 'ISpRecognizer3',
    'DISPIDSPTSI_SelectionLength',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SAFT8kHz8BitMono',
    'SVSFParseSsml', 'DISPID_SBSSeek', 'SGDSActive',
    'DISPID_SOTGetStorageFileName', 'DISPID_SRCEAdaptation',
    'DISPID_SOTDataKey', 'SPEI_MIN_SR', 'eWORDTYPE_DELETED',
    'SP_VISEME_20', 'DISPID_SVEWord', 'SSSPTRelativeToEnd',
    'SPEI_SR_PRIVATE', 'SVP_11', 'SREPropertyStringChange',
    'SAFT44kHz8BitStereo', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SpeechRecoContext', 'SPEI_VOICE_CHANGE',
    'DISPID_SOTCDefault', 'SPWORDTYPE', 'SRSEDone',
    'ISequentialStream', 'DISPID_SpeechAudioStatus', 'SP_VISEME_15',
    ...
    'DISPID_SOTDisplayUI', 'SPGRAMMARWORDTYPE',
    'SAFTCCITT_uLaw_11kHzMono', 'SECLowConfidence',
    'SpeechGrammarState', 'SAFT48kHz8BitMono',
    'DISPID_SGRsCommitAndSave', 'SVSFIsFilename',
    'eLEXTYPE_RESERVED4', 'DISPID_SRGState', 'DISPID_SPIGrammarId',
    'SAFTCCITT_uLaw_22kHzMono', 'ISpRecognizer2', 'SPPHRASEELEMENT',
    'ISpStream', 'SpSharedRecognizer', 'SWTDeleted', 'SVSFPersistXML',
    'DISPID_SPIStartTime', 'SPSHORTCUTPAIRLIST',
    'DISPID_SPRDisplayAttributes', 'eLEXTYPE_USER',
    'SPPS_NotOverriden', 'SpInprocRecognizer',
    'DISPID_SPERetainedStreamOffset', 'SP_VISEME_3',
    'DISPID_SRCVoice', 'DISPID_SWFEBlockAlign', 'SPWORDPRONOUNCEABLE',
    'SpeechCategoryPhoneConverters', 'DISPID_SMSALineId',
    'SSTTWildcard', 'SPWORDPRONUNCIATIONLIST',
    'SWPUnknownWordPronounceable', 'DISPID_SRRGetXMLResult',
    'DISPID_SPERetainedSizeBytes', 'SpeechTokenKeyAttributes',
    'SVEBookmark', 'SDKLCurrentUser',
    'DISPID_SRCEPropertyNumberChange',
    'DISPID_SPRuleEngineConfidence', 'SBONone',
    '__MIDL_IWinTypes_0009', 'SAFTADPCM_44kHzStereo',
    'SPRECOGNIZERSTATUS', 'DISPID_SPPValue',
    'DISPID_SPRuleConfidence', 'SPRS_INACTIVE',
    'DISPID_SpeechMemoryStream', 'SpObjectTokenCategory',
    'SpNullPhoneConverter', 'SpeechAudioVolume',
    'DISPID_SDKGetBinaryValue', 'DISPID_SDKOpenKey',
    'DISPID_SASFreeBufferSpace', 'DISPID_SRGDictationUnload',
    'Speech_StreamPos_Asap', 'SRESoundEnd', 'ISpXMLRecoResult',
    'DISPID_SLWPronunciations', 'SPCT_COMMAND',
    'DISPID_SPPNumberOfElements', 'SAFT24kHz8BitMono',
    'DISPID_SLPsItem', 'ISpeechVoiceStatus', 'SP_VISEME_8',
    'SpWaveFormatEx', 'SPPS_Function', 'DISPID_SRGSetTextSelection',
    'SRSInactive', 'SPSMF_UPS', 'SPEI_RECOGNITION',
    'SDA_Two_Trailing_Spaces', 'eLEXTYPE_USER_SHORTCUT',
    'SpeechVoicePriority', 'DISPID_SBSWrite',
    'SpeechDictationTopicSpelling', 'SpeechTokenKeyUI',
    'DISPID_SOTsCount', 'DISPID_SAFType', 'SPPARTOFSPEECH',
    'SRSActiveAlways', 'DISPID_SVStatus', 'eLEXTYPE_PRIVATE8',
    'SPBOOKMARKOPTIONS', 'DISPID_SPPId', 'DISPID_SRCBookmark',
    'ISpPhoneConverter', 'SVSFParseSapi',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPEI_PROPERTY_STRING_CHANGE',
    'SP_VISEME_19', 'ISpNotifyTranslator', 'SPEI_HYPOTHESIS',
    'DISPID_SLPsCount', 'WAVEFORMATEX', 'SpeechCategoryRecoProfiles',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPPEngineConfidence',
    'SAFT8kHz16BitMono', 'DISPID_SGRSAddRuleTransition',
    'SWPKnownWordPronounceable', 'DISPID_SRRecognizer',
    'ISpeechPhraseRule', 'SDTDisplayText', 'DISPID_SVEPhoneme',
    'ISpeechAudioFormat', 'SREFalseRecognition', 'SPXRO_SML',
    'DISPID_SpeechMMSysAudio', 'DISPID_SPEDisplayAttributes',
    'ISpeechGrammarRules', 'DISPID_SPEs_NewEnum', 'SP_VISEME_18',
    'DISPID_SRIsShared', 'ISpeechRecoContext', 'DISPID_SGRSTType',
    'DISPID_SPEAudioTimeOffset', 'STSF_FlagCreate', 'SP_VISEME_5',
    'ISpeechTextSelectionInformation', 'DISPID_SRGCmdLoadFromMemory',
    'SpeechAudioFormatGUIDWave', 'SP_VISEME_17',
    'DISPID_SRIsUISupported', 'SRADefaultToActive', 'SVP_19',
    'DISPID_SRRTLength', 'SP_VISEME_7', 'SPRST_NUM_STATES',
    'SpUnCompressedLexicon', 'SRERequestUI', 'DISPID_SVVolume',
    'DISPID_SLGetPronunciations', 'DISPID_SRGetFormat',
    'DISPID_SRRSetTextFeedback', 'SpeechLoadOption', 'SASPause',
    'STCLocalServer', 'DISPID_SpeechGrammarRule',
    'DISPID_SPEEngineConfidence', 'SREPropertyNumChange',
    'DISPID_SPEActualConfidence', 'ISpRecognizer', 'DISPID_SGRSTRule',
    'DISPID_SpeechRecoContextEvents', 'ISpeechAudioStatus',
    'SSTTTextBuffer', 'SPBINARYGRAMMAR', 'SECHighConfidence',
    'ISpeechPhraseReplacements', 'SPSHT_OTHER',
    ...
    'SINoSignal', 'DISPID_SVSPhonemeId',
    'DISPID_SPERequiredConfidence', 'SPSHT_NotOverriden',
    'SP_VISEME_1', 'DISPID_SpeechLexicon', 'SPSLMA', 'DISPID_SLWWord',
    'IEnumString', 'DISPID_SVEStreamStart', 'SP_VISEME_14',
    'SVPAlert', 'DISPID_SPIRetainedSizeBytes', 'SPPHRASEREPLACEMENT',
    'DISPID_SPEAudioSizeTime', 'SPEI_PHONEME', 'SPPS_Verb',
    'ISpStreamFormatConverter', 'DISPID_SPIReplacements',
    'DISPID_SRRSaveToMemory', 'DISPID_SVEViseme',
    'eLEXTYPE_RESERVED10', 'SVP_0', 'SAFT12kHz8BitStereo',
    'DISPID_SPPChildren', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SRCPause', 'SPRST_ACTIVE', 'DISPID_SOTMatchesAttributes',
    'SAFT22kHz8BitMono', 'SpShortcut', 'SGRSTTTextBuffer',
    'DISPID_SAFSetWaveFormatEx', 'ISpPhraseAlt', 'SECFIgnoreKanaType',
    'DISPID_SRRAlternates', 'SPRST_ACTIVE_ALWAYS',
    'SAFTADPCM_8kHzStereo', 'SSFMOpenForRead',
    'DISPID_SRCCreateGrammar', 'DISPIDSPRG', 'DISPID_SVEVoiceChange',
    'SECFDefault', 'SRARoot', 'SPDKL_LocalMachine',
    'DISPID_SRGIsPronounceable', 'SPEI_PHRASE_START',
    'SPSERIALIZEDRESULT', 'LONG_PTR', 'SPLO_STATIC',
    'DISPID_SVSRunningState', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SLGetWords', 'SAFTADPCM_8kHzMono', 'SPAS_RUN',
    'DISPID_SPIAudioSizeBytes', 'SAFTADPCM_11kHzStereo',
    'DISPID_SPIAudioStreamPosition', 'SAFTGSM610_11kHzMono',
    'DISPID_SRRPhraseInfo', 'SINoise', 'SAFTCCITT_ALaw_8kHzMono',
    'SPEI_PROPERTY_NUM_CHANGE', 'SGSEnabled',
    'SPEI_RECO_STATE_CHANGE', 'SVEViseme',
    'DISPID_SRGCmdLoadFromResource', 'SpeechVisemeFeature',
    'DISPID_SVSpeakStream', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SAFT32kHz16BitStereo', 'ISpeechPhoneConverter',
    'DISPID_SRGCommit', 'DISPID_SFSOpen', 'DISPID_SDKGetStringValue',
    ...
    'SDKLCurrentConfig', 'SAFT24kHz16BitMono', 'SRSActive',
    'DISPID_SOTCategory', 'SpTextSelectionInformation', 'SDTRule',
    'SVSFUnusedFlags', 'SVEPrivate', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'ISpPhoneticAlphabetConverter', 'DISPID_SRGCmdSetRuleState',
    'SGDSActiveWithAutoPause', 'DISPID_SGRName', 'eLEXTYPE_PRIVATE9',
    'eLEXTYPE_PRIVATE11', 'DISPID_SPAs_NewEnum',
    'SAFT22kHz8BitStereo', 'SAFTExtendedAudioFormat',
    'ISpeechLexiconWord', 'SRADynamic', 'DISPID_SGRSTNextState',
    'SECFEmulateResult', 'SITooQuiet', 'ISpEventSource',
    'ISpResourceManager', 'SAFT32kHz8BitStereo',
    'DISPID_SpeechDataKey', 'SWTAdded', 'DISPID_SPAsItem',
    'DISPID_SRSClsidEngine', 'DISPIDSPTSI',
    'DISPID_SASCurrentDevicePosition', 'SPEI_REQUEST_UI',
    'SAFT48kHz16BitStereo', 'DISPID_SVGetProfiles',
    'DISPID_SPPsCount', 'SAFT32kHz16BitMono', 'SPAR_Medium', 'SVP_18',
    'DISPID_SBSFormat', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SRRSpeakAudio', 'DISPID_SLPLangId', 'SpeechLexiconType',
    'SpeechCategoryAppLexicons', 'DISPID_SABIBufferSize',
    'DISPID_SDKDeleteValue', 'SPAS_STOP', 'SPVPRI_NORMAL',
    'DISPID_SPISaveToMemory', 'eLEXTYPE_PRIVATE12',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SRCRetainedAudio', 'ISpVoice',
    'DISPID_SLGetGenerationChange', 'SVP_6', 'DISPID_SPRs_NewEnum',
    'SPBO_AHEAD', 'DISPID_SRStatus', 'eLEXTYPE_PRIVATE5',
    'SFTSREngine', 'SPCT_SLEEP', 'DISPID_SRRTTickCount',
    'DISPID_SpeechLexiconPronunciation', 'SPSHORTCUTTYPE',
    'SAFTCCITT_ALaw_22kHzMono', 'SREStateChange',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SAFTADPCM_22kHzStereo',
    'DISPID_SVSpeak', 'SPEI_INTERFERENCE', 'DISPID_SDKSetBinaryValue',
    'DISPID_SLWType', 'SpeechStreamFileMode',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SRAudioInputStream',
    ...
    'DISPID_SCSBaseStream', 'DISPID_SRRTOffsetFromStart',
    'SAFT44kHz16BitStereo', 'SITooLoud', 'DISPID_SRCESoundEnd',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SAFGuid',
    'eLEXTYPE_PRIVATE7', 'eLEXTYPE_RESERVED9', 'STCAll',
    'SAFT22kHz16BitStereo', 'SVSFlagsAsync', 'SAFTNoAssignedFormat',
    'DISPID_SABIMinNotification', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPSFunction', 'SDKLDefaultLocation', 'DISPID_SADefaultFormat',
    'SAFTCCITT_ALaw_11kHzMono', 'SPTEXTSELECTIONINFO',
    'DISPID_SVVoice', 'DISPID_SRCEBookmark', 'SAFT8kHz16BitStereo',
    'SAFT11kHz16BitMono', 'SRSInactiveWithPurge', 'SGPronounciation',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPWORDPRONUNCIATION',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SPRsItem',
    'SAFT24kHz16BitStereo', 'SpeechPropertyComplexResponseSpeed',
    'SVSFIsNotXML', 'ISpEventSink', 'SREPhraseStart', 'SVSFDefault',
    'DISPID_SPIRule', 'DISPID_SRGetPropertyString',
    'DISPID_SAFGetWaveFormatEx', 'ISpeechPhraseProperty',
    'SpObjectToken', 'DISPID_SOTs_NewEnum', 'SpeechVoiceSpeakFlags',
    'SPPS_RESERVED2', 'IStream', 'SPAR_High', 'DISPID_SLGenerationId',
    ...
    'DISPID_SpeechLexiconWord', 'DISPID_SVSCurrentStreamNumber',
    'SPPS_RESERVED4', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SLPPartOfSpeech', 'DISPID_SMSAMMHandle', 'SPFM_CREATE',
    'DISPID_SPAStartElementInResult', 'SPAO_NONE', 'SECFIgnoreCase',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SpeechTokenShellFolder', 'DISPID_SpeechObjectTokenCategory',
    'SPEI_MIN_TTS', 'SVSFIsXML', 'DISPID_SRRDiscardResultInfo',
    'SpSharedRecoContext', 'tagSTATSTG', 'SDTReplacement',
    '_ISpeechRecoContextEvents', 'DISPID_SpeechRecoResult2',
    'ISpeechLexiconPronunciation', 'eLEXTYPE_RESERVED8', 'SLTUser',
    'STCRemoteServer', 'DISPID_SGRSTsItem', 'DISPID_SAStatus',
    'DISPID_SWFEBitsPerSample', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SVSkip', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SDA_Consume_Leading_Spaces', 'DISPID_SPRuleParent', 'SGLexical',
    'DISPID_SVESentenceBoundary', 'SpeechAudioState', 'DISPID_SOTId',
    'SREAdaptation', 'SPSEMANTICFORMAT', 'ISpProperties',
    'SAFT24kHz8BitStereo', 'DISPID_SGRSTText', 'SPRULESTATE',
    'SVSFVoiceMask', 'DISPID_SpeechPhraseProperties',
    'eLEXTYPE_PRIVATE2', 'SPAUDIOOPTIONS', 'SRAExport', 'SREBookmark',
    'SVP_21', 'SLODynamic', 'DISPID_SpeechLexiconProns',
    'SVEEndInputStream', 'SPSSuppressWord',
    'SpeechEmulationCompareFlags', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SVGetVoices', 'SpResourceManager', 'SGRSTTWord',
    'ISpNotifySink', 'SPEI_RESERVED2', 'DISPID_SPEsItem',
    'SPXRO_Alternates_SML', 'DISPID_SPRuleFirstElement',
    'SpFileStream', 'ISpeechAudio', 'SpeechPropertyAdaptationOn',
    'SPEI_UNDEFINED', 'DISPID_SpeechObjectTokens',
    'DISPID_SVSVisemeId', 'SPAUDIOSTATE', 'SVSFParseMask',
    'DISPID_SPIEngineId', 'SP_VISEME_9', 'SPVPRIORITY', 'SPRECOSTATE',
    'eLEXTYPE_PRIVATE1', 'DISPID_SVEAudioLevel', 'SGRSTTRule',
    'DISPID_SRCERequestUI', 'SRTSMLTimeout', 'SpCompressedLexicon',
    'SPEI_RESERVED5', 'SPVPRI_OVER', 'DISPID_SRGetPropertyNumber',
    'SREStreamStart', 'DISPID_SGRsCommit',
    ...
    'ISpGrammarBuilder', 'SRTReSent', 'DISPID_SVGetAudioInputs',
    'SP_VISEME_12', 'DISPID_SWFESamplesPerSec',
    'DISPID_SRCAudioInInterferenceStatus', 'SpeechRuleState',
    'DISPID_SRGSetWordSequenceData', 'SpMMAudioOut', 'ISpRecoGrammar',
    'SAFTCCITT_uLaw_8kHzMono', 'SECFNoSpecialChars',
    'DISPID_SRGRules', 'SpeechRunState', 'SpeechDataKeyLocation',
    'DISPID_SRGetRecognizers', 'DISPID_SLAddPronunciationByPhoneIds',
    'SVEAllEvents', 'SRERecoOtherContext',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SPEDisplayText',
    'SAFT32kHz8BitMono', 'SpeechCategoryAudioIn',
    'DISPID_SpeechRecognizer', 'SVEAudioLevel', 'SP_VISEME_0',
    'SAFT16kHz8BitMono', 'SpeechVoiceCategoryTTSRate', 'SPVPRI_ALERT',
    'SPAUDIOBUFFERINFO', 'STSF_CommonAppData',
    'DISPID_SRGDictationLoad', 'DISPID_SRRTStreamTime',
    'SAFTCCITT_uLaw_44kHzMono', 'ISpeechXMLRecoResult',
    'SAFT11kHz8BitMono', 'ISpeechRecoResult2', 'SAFT16kHz16BitMono',
    'DISPID_SGRsItem', 'DISPID_SRCERecognition', 'SP_VISEME_4',
    'DISPID_SRGCmdSetRuleIdState', 'ISpRecoContext', 'SPPS_LMA',
    'SPFM_OPEN_READWRITE', 'ISpeechPhraseInfo',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SpeechRecoResult',
    'SINone', 'SPSTREAMFORMATTYPE', 'ISpPhrase',
    'ISpeechRecoResultDispatch', 'SPPS_Interjection',
    'SpeechDisplayAttributes', 'SDA_One_Trailing_Space',
    'SECFIgnoreWidth', 'eLEXTYPE_PRIVATE4', 'SRTExtendableParse',
    'SpeechFormatType', 'SPSHT_EMAIL', 'SPCS_ENABLED', 'SVP_8',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SOTRemove', 'SGDSInactive',
    'SPCT_SUB_DICTATION', 'DISPID_SPIGetText', 'SVP_16',
    'SRAORetainAudio', 'SVEVoiceChange', 'ISpeechRecognizer',
    'SVESentenceBoundary', 'SREStreamEnd', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SVAudioOutputStream', 'SLTApp',
    'SAFTCCITT_ALaw_44kHzMono', 'SSFMCreate',
    'DISPID_SGRInitialState', 'SPCT_DICTATION', 'SAFT11kHz8BitStereo',
    'SPPROPERTYINFO', 'SpMemoryStream', 'ISpeechPhraseProperties',
    'DISPID_SRCEPhraseStart', 'DISPID_SLWLangId',
    'DISPID_SpeechVoiceEvent', 'SRCS_Disabled', 'DISPID_SPRulesCount',
    'ISpeechLexiconWords', 'ISpeechDataKey',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SpeechLexiconWords',
    'SAFTDefault', 'DISPID_SRCRequestedUIType', 'SPWORD',
    ...
    'SpeechMicTraining', 'SVF_None', 'DISPID_SpeechFileStream',
    'SPWT_DISPLAY', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SVSLastBookmarkId', 'SVEPhoneme', 'SPSInterjection',
    'SPAO_RETAIN_AUDIO', 'STSF_AppData', 'SPGS_DISABLED',
    'SPINTERFERENCE_TOOFAST', 'SGRSTTWildcard',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SRDisplayUI',
    'SPADAPTATIONRELEVANCE', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SPAPhraseInfo', 'DISPID_SGRsDynamic', 'SPVOICESTATUS',
    'SVP_4', 'SPCONTEXTSTATE', 'SBOPause', 'SAFTADPCM_22kHzMono',
    'SSSPTRelativeToCurrentPosition', 'SVSFNLPSpeakPunc', 'SASStop',
    'DISPID_SVSLastBookmark', 'SAFT16kHz16BitStereo',
    'DISPID_SGRsAdd', 'DISPID_SLAddPronunciation', 'DISPID_SRGReset',
    'ISpeechPhraseAlternate', 'DISPID_SpeechPhraseElement',
    'SPRS_ACTIVE', 'DISPID_SASNonBlockingIO', 'DISPID_SPRuleChildren',
    'DISPID_SPIElements', 'SPAR_Unknown', 'DISPID_SVSInputWordLength',
    'DISPID_SRCESoundStart', 'eLEXTYPE_APP', 'ISpeechPhraseElement',
    'DISPID_SGRSTPropertyName', 'DISPID_SRCEStartStream',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SPACommit',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SpeechPhoneConverter',
    'SpeechRegistryUserRoot', 'ISpeechObjectToken', 'SRAInterpreter',
    'SP_VISEME_16', 'ISpeechCustomStream', 'SRATopLevel',
    'ISpObjectToken', 'DISPID_SpeechVoiceStatus',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SOTGetAttribute',
    'DISPID_SGRId', 'SVP_15', 'SPLEXICONTYPE', 'DISPID_SVPriority',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SPIAudioSizeTime',
    'SPBO_NONE', 'SpeechWordPronounceable', 'SpeechBookmarkOptions',
    'DISPID_SPRFirstElement', 'ISpeechPhraseElements',
    'SPWAVEFORMATTYPE', 'SpeechGrammarRuleStateTransitionType',
    'SPRECOCONTEXTSTATUS', 'ISpeechMMSysAudio',
    'DISPID_SpeechCustomStream', 'DISPID_SGRClear',
    'SAFT44kHz8BitMono', 'SFTInput', 'SVSFParseAutodetect',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SOTRemoveStorageFileName',
    'SpeechPropertyResourceUsage', 'SAFTADPCM_11kHzMono',
    'ISpNotifySource', 'DISPID_SPCIdToPhone', 'SPAS_PAUSE',
    'ISpObjectWithToken', 'SREAudioLevel', 'SPEI_RESERVED6',
    'SPGS_ENABLED', 'DISPID_SRGDictationSetState', 'SPSHT_Unknown',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFTCCITT_uLaw_44kHzStereo', 'SpPhoneConverter',
    'SAFTADPCM_44kHzMono', 'DISPID_SPRuleName', 'SPBO_TIME_UNITS',
    'DISPID_SVResume', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SVEBookmark', 'SpLexicon', 'DISPID_SVSLastResult',
    'SASClosed', 'SPINTERFERENCE_TOOQUIET', 'DISPID_SRCEAudioLevel',
    'SPEI_WORD_BOUNDARY', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SREmulateRecognition', 'SPEVENT',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SOTIsUISupported',
    'SpeechAllElements', 'SPEI_SR_RETAINEDAUDIO', 'SPEI_TTS_PRIVATE',
    'DISPID_SRCEPropertyStringChange', 'SpeechTokenValueCLSID',
    'SPRECORESULTTIMES', 'ISpShortcut', 'SDTAll',
    'DISPID_SDKCreateKey', 'SVPNormal', 'DISPID_SRProfile',
    'SAFT12kHz16BitMono', 'ISpRecoContext2', 'DISPID_SPEsCount',
    'SPEI_RESERVED3', 'ISpeechGrammarRuleStateTransitions',
    'IInternetSecurityMgrSite', 'tagSPTEXTSELECTIONINFO',
    'SPDKL_CurrentConfig', 'SSFMOpenReadWrite',
    'DISPID_SDKEnumValues', 'SpeechVisemeType',
    'ISpeechLexiconPronunciations', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SRCResume', 'DISPID_SRState', 'SpeechGrammarWordType',
    'SGSDisabled', 'ISpLexicon', 'ISpAudio', 'tagSPPROPERTYINFO',
    'SLOStatic', 'DISPID_SPRuleId', 'eLEXTYPE_PRIVATE10',
    'ISpeechPhraseReplacement', 'SpeechCategoryAudioOut',
    'DISPID_SPPName', 'DISPID_SLWsItem', 'DISPID_SVEventInterests',
    'SVP_12', 'STCInprocServer',
    ...
    'SpeechGrammarTagUnlimitedDictation', 'SVP_17', 'DISPID_SOTSetId',
    'DISPID_SMSGetData', 'DISPID_SAVolume', 'DISPID_SLWsCount',
    'DISPID_SRSSupportedLanguages', 'DISPID_SRCRecognizer',
    'eLEXTYPE_PRIVATE3', 'SPSNotOverriden', 'SpPhraseInfoBuilder',
    'SpeechTokenKeyFiles', 'DISPID_SPRText', 'SpNotifyTranslator',
    'SVP_20', 'SDTProperty', 'ISpeechObjectTokenCategory',
    'DISPID_SLPs_NewEnum', 'SpAudioFormat', 'eLEXTYPE_PRIVATE20',
    'SASRun', 'ISpeechWaveFormatEx', 'SPEI_TTS_BOOKMARK',
    'DISPID_SRAudioInput', 'SPRULE', 'ISpeechResourceLoader',
    'SPFM_CREATE_ALWAYS', 'SpeechRecognizerState',
    ...
    'DISPID_SRSAudioStatus', 'SPWT_PRONUNCIATION',
    'ISpeechGrammarRule', 'DISPID_SDKGetlongValue',
    'DISPID_SGRSTPropertyId', 'ISpeechVoice',
    'DISPID_SGRSTPropertyValue', 'DISPID_SRCEventInterests', 'SVP_5',
    'SRESoundStart', 'SpeechGrammarTagWildcard',
    'DISPID_SWFEFormatTag', 'SVP_2', 'SpeechEngineProperties',
    'DISPID_SLPPhoneIds', 'SPEI_MAX_SR', 'DISPID_SpeechObjectToken',
    'SSSPTRelativeToStart', 'SPXMLRESULTOPTIONS',
    'DISPID_SDKEnumKeys', 'SPEI_END_SR_STREAM', 'DISPID_SPPsItem',
    'eLEXTYPE_RESERVED7', 'DISPID_SPPBRestorePhraseFromMemory',
    'SVF_Emphasis', 'SPPS_RESERVED1', 'DISPID_SpeechAudioFormat',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SLRemovePronunciation',
    'SPPS_Unknown', 'SDKLLocalMachine', 'DISPID_SAEventHandle',
    'SDTPronunciation', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SOTCId', 'ISpeechRecoResult',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SASState',
    'DISPID_SRSetPropertyNumber', 'SVF_Stressed',
    'SpeechGrammarTagDictation', 'SPINTERFERENCE_NONE',
    'DISPID_SVEEnginePrivate', 'DISPID_SpeechAudio', 'SPWT_LEXICAL',
    'ISpeechPhraseRules', 'DISPID_SRGRecoContext',
    'SPINTERFERENCE_NOISE', 'SAFTGSM610_8kHzMono',
    'DISPID_SWFEChannels', 'STCInprocHandler', 'SpeechRecoEvents',
    'DISPID_SABufferInfo', 'DISPID_SRGId', 'DISPID_SOTCreateInstance',
    'DISPID_SpeechPhraseRule', 'SP_VISEME_6', 'SPFM_NUM_MODES',
    'SPPS_Noun', 'DISPID_SMSSetData', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SVDisplayUI', 'SPSModifier', 'SPSNoun', 'SGDisplay',
    'SVP_1', 'DISPID_SVRate', 'SPINTERFERENCE',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPPS_SuppressWord', 'SP_VISEME_10',
    'SpStreamFormatConverter', 'ISpMMSysAudio', 'SAFTText',
    'SPEVENTENUM', 'ISpeechRecoResultTimes', 'SpeechCategoryVoices',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SpeechGrammarRuleState', 'SPPHRASE', 'SRAONone',
    'SPEI_TTS_AUDIO_LEVEL', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SECNormalConfidence', 'SRCS_Enabled', 'DISPID_SPILanguageId',
    'DISPID_SDKDeleteKey', 'SPDATAKEYLOCATION', 'SP_VISEME_13',
    'SPFM_OPEN_READONLY', 'SpeechCategoryRecognizers',
    'ISpeechObjectTokens', 'SRSEIsSpeaking', 'SP_VISEME_11',
    'UINT_PTR', 'DISPID_SRCCreateResultFromMemory',
    'SPPHRASEPROPERTY', 'SpeechStreamSeekPositionType',
    'ISpeechLexicon', 'SpeechTokenContext', 'DISPID_SRCState',
    'DISPID_SLPSymbolic', 'SpCustomStream',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPSHORTCUTPAIR',
    'SGRSTTEpsilon', 'SAFT11kHz16BitStereo', 'SVP_3', 'DISPID_SBSRead'
]

_check_version('1.1.14', 1657237630.447672)
